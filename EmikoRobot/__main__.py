...
PM_START_TEXT = """
*♚ Hᴇᴍʟᴏᴏᴏᴏ, {} !* 🍾
『 Nɪᴄᴇ ᴛᴏ ᴍᴇᴇᴛ ʏᴀ , Mʏsᴇʟғ ᴄᴜᴛɪᴇᴘɪᴇ 
 Cᴜᴛɪᴇᴘɪᴇ ʀᴏʙᴏᴛ ɪꜱ ᴀɴ ᴀɴɪᴍᴀᴛᴇᴅ ᴛʜᴇᴍᴇᴅ 
 ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ ᴡʜɪᴄʜ ᴄᴀɴ ʜᴇʟᴘ 
 ʏᴏᴜ ᴛᴏ ᴍᴀɴᴀɢᴇ ᴀɴᴅ ꜱᴇᴄᴜʀᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ
 ᴡɪᴛʜ ʜᴜɢᴇ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ᴘʟᴜɢɪɴꜱ
 ʟɪᴋᴇ ; ꜰɪʟᴛᴇʀꜱ , ɴᴏᴛᴇꜱ , ᴡᴇᴄᴏᴍᴇ ,
 ɢᴏᴏᴅ ʙʏᴇ , ʙᴀɴɴɪɴɢ , ᴍᴜᴛɪɴɢ ᴀɴᴅ ᴍᴀɴʏ
  ᴍᴏʀᴇ.. Sᴏ ᴡʜᴀᴛ ᴀʀᴇ ʏᴏᴜ ᴡᴀɪᴛɪɴғ ғᴏʀ..!
 ᴊᴜsᴛ ᴀᴅᴅ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴍᴀᴋᴇ
 ᴍᴇ ᴀᴅᴍɪɴ ᴛʜᴇɴ ʟᴇᴛ ᴍᴇ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ.! [🍀](https://telegra.ph/file/4c14cbb141189eeea0c9c.mp4)
 *╔══════❖•ೋ° °ೋ•❖══════╗*
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="⚜️ ᴀᴅᴍɪɴꜱ ʜᴇʟᴩ ⚜️", callback_data="emiko_admin"),
                    InlineKeyboardButton(text="🗒️ ɴᴏᴛᴇꜱ 🗒️", callback_data="emiko_notes"),
                 ],
                 [
