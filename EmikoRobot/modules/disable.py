...
if is_module_loaded(FILENAME):
        ...
        if len(args) >= 1:
            ...
            if disable_cmd in set(DISABLE_CMDS + DISABLE_OTHER):
                ...
                update.effective_message.reply_text(
                    f"Dɪsᴀʙʟᴇᴅ ᴛʜᴇ ᴜsᴇ ᴏғ `{disable_cmd}`",
                    parse_mode=ParseMode.MARKDOWN,
                )
            else:
                update.effective_message.reply_text("Tʜᴀᴛ ᴄᴏᴍᴍᴀɴᴅ ᴄᴀɴ'ᴛ ʙᴇ ᴅɪsᴘʟᴀʏᴇᴅ")

        else:
            update.effective_message.reply_text("Wʜᴀʏ sᴊᴏᴜʟᴅ ɪ ᴅɪsᴀʙʟᴇ?")
    ...
    def disable_module(update: Update, context: CallbackContext):
        ...
        if len(args) >= 1:
            ...
            if failed_disabled_cmds:
                ...
                update.effective_message.reply_text(
                    f"Cᴏᴍᴍᴀɴᴅs `{failed_disabled_cmds_string}` ᴄᴀɴ'ᴛ ʙᴇ ᴅɪsᴀʙʟᴇᴅ",
                    parse_mode=ParseMode.MARKDOWN,
                )
    ...
    def enable(update: Update, context: CallbackContext):
        ...
        if len(args) >= 1:
            ...
            if sql.enable_command(chat.id, enable_cmd):
                update.effective_message.reply_text(
                    f"Eɴᴀʙʟᴇᴅ ᴛʜᴇ ᴜsᴇ ᴏғ `{enable_cmd}`",
                    parse_mode=ParseMode.MARKDOWN,
                )
            else:
            ...
            update.effective_message.reply_text("Wʜᴀᴛ sʜᴏᴜʟᴅ ɪ ᴇɴᴀʙʟᴇ?")
    ...
    def enable_module(update: Update, context: CallbackContext):
        ...
        if len(args) >= 1:
            ...
            try:
                ...
                update.effective_message.reply_text(
                    "Mᴏᴅᴜʟᴇ ᴅᴏᴇsɴ'ᴛ ᴄᴏɴᴛᴀɪɴ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ!",
                )
                return
            ...
            if failed_enabled_cmds:
                ...
                update.effective_message.reply_text(
                    f"Aʀᴇ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅs `{failed_enabled_cmds_string}` ᴇᴠᴇɴ ᴅɪsᴀʙʟᴇᴅ?",
                    parse_mode=ParseMode.MARKDOWN,
                )
    ...
    def list_cmds(update: Update, context: CallbackContext):
        if DISABLE_CMDS + DISABLE_OTHER:
            ...
            update.effective_message.reply_text(
                f"Tʜᴇ ғᴏʟʟᴏᴡɪɴɢ ᴄᴏᴍᴍᴀʜᴅs ᴀʀᴇ ᴛᴏɢɢʟᴇᴀʙʟᴇ:\n{result}",
                parse_mode=ParseMode.MARKDOWN,
            )
        else:
...
➻ /listcmds*:* Lɪsᴛ ᴀʟʟ ᴘᴏssɪʙʟᴇ ᴛᴏɢɢʟᴇᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅs.
"""
